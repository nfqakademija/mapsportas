...
class AppFixtures extends Fixture
{
    private const USERNAMES = [
        'user','extraUser','vartotojas','papildomasVartotojas','sportininkas','begikas','tiesiogVartotojas','nežinau','žinau','turbo',
    ];

    private const NAMES = [
        'Petras','Jonas','Darius','Marius','Tomas','Romas','Kestas','Albinas','Vytautas','Rimas',
    ];

    private const SURNAMES = [
        'Jonaitis','Petraitis','Jurgaitis','Danilevičius','Jurkus','Petkevičius','Petkus','Astrauskas','Sabonis','Junka',
    ];

    private const SPORT_TYPES = [
        'Krepšinis','Bėgimas','Boulingas','Futbolas','Biliardas','Smiginis','Regbis','Tinklinis','Rankinis','Tenisas','Stalo Tenisas',
    ];

    private const ADRESSES = [
      'Taikos g. 111B, Vilnius 05202','Čiobiškio g. 1, Vilnius 07179','Priegliaus g. 8, Vilnius 06269','Šeškinės sen, Vilnius 07172','Širvintų g. 82, Vilnius 08216',
        'A. P. Kavoliuko g. 28, Vilnius 04329','Viršuliškių g. 40, Vilnius 05112','Ukmergės g. 369, Vilnius 06327',
    ];
